...
@section('title') Sysges Don Bosco - Entrée produit @endsection
@section('contenu')
<div class="card">
    <div class="card-body">
      <h5 class="card-title">Enregistrer une entrée</h5>

      <!-- Multi Columns Form -->
      <form class="row g-3" method="POST" action="{{route('entree.store')}}"  enctype="multipart/form-data">
        @csrf
        <div class="col-md-6">
          <label for="inputName5" class="form-label">Référence</label>
          <input type="text" class="form-control" name="reference" id="inputName5" required>
        </div>
        <div class="col-md-6">
          <label for="inputName5" class="form-label">date</label>
          <input type="date" class="form-control" name="date_reception" id="inputName5" required>
        </div>
        <div class="col-md-6">
          <label for="inputEmail5" class="form-label">Bordereau de réception</label>
...
<!-- End entête tableau multiple -->
  ...
  <script>
    $(document).ready(function() {
        ...
        '<td class="align-top"><input type="number" min="0" class="form-control" size="20" name="prix_unitaire[]" data-group="%group%" data-id="prix_unitaire" value="0" required></td>' +
