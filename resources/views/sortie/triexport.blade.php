...
@section('title') Sysges Don Bosco - Exporter sorties en pdf @endsection
@section('contenu')
<div class="card">
    <div class="card-body">
      <h5 class="card-title">Exporter les sorties en PDF</h5>

      <!-- Multi Columns Form -->
      <form class="row g-3" method="POST" action="{{route('sortie.export')}}"  enctype="multipart/form-data">
        @csrf
        <div class="col-md-6">
